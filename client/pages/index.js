...
const HomePage = () => {
  ...
  return (
    <>
      <Head>
        <title>Restaurant Name - Welcome!</title>
        <meta name="description" content="Welcome to [Restaurant Name]! Explore our delicious menu, order online, and enjoy the finest culinary experience." />
      </Head>
      <Header />
